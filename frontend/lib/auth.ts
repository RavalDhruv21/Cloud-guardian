...
export const getCurrentUser = (): any | null => {
  ...
  try {
    // With Cognito, we rely on the profile existing in localStorage
    // (Amplify manages the actual tokens securely in the background)
...
export const loginUser = async (email: string, password: string): Promise<any> => {
  try {
    ...
    // Fetch the real tokens to initialize the session in Amplify
